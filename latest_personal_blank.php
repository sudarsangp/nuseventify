...
<style>
	#elem{
     background: url('az_subtle_@2X.png') center center no-repeat;
...
<body>
	...
	<div id="hellobar-pusher" style="height: 33px;"></div><div style="display: block; position: fixed; width: 100%; top: 0px; left: 0px; z-index: 5000; height: 33px;" id="hellobar-wrapper" class=" hellobar-right hellobar-dark-images hellobar-button-default hellobar-button"><div id="hellobar-container" style="top: 0px;"><span>Eventify Your Life!</span><a class="hellobar-cta-link" href="http://localhost/Hackathon/SubmitEvent2.php" target="_blank">Submit Your Event</a><a class="hellobar-cta-link" href="http://localhost/Hackathon/places.html" target="_blank">Locate Events</a><a class="hellobar-cta-link" href="http://localhost/Hackathon/ivle.html" target="_blank">IVLE Events</a><a href="#close" id="hellobar-close">Close</a><div id="hellobar-shadow"></div></div><span></span></span><a href="#close" id="hellobar-open" style="top: -96px;">Open</a></div><div id="wrap">
	
	
		<div class="container">
   	<img src="Eventify.jpg"  height = "150px" width="1450px" border=0 /></a><br>
						...
						<div id="competitionsCarousel" class="carousel slide" style="margin: 0px 0px 0px; width = 1200; height=100; overf">
	  					...
	  					<div class="carousel-inner" id='event-carousel'>
		    				<!--<div class="active item" id="foo">
		    					<a target='_blank' href="http://www.kinglyprojects.co.uk">
		    					<img class="peopleCarouselImg"  
		    					src="http://www.kinglyprojects.co.uk/sites/default/files/images/events-and-programs-lo-res.jpg"></a>  
		    				</div>	-->
		    				<?php
		    				$i=0;
		...
		<div id="talksCarousel" class="carousel slide" style="margin: 0px 0px 0px; width = 1200; height=100; overf">
  					...
  					<div class="carousel-inner">
	    				...
	    				<a target="_blank" href="http://www.santamonica.com">
	    					<img class="peopleCarouselImg" src="http://www.santamonica.com/includes/media/images/Calendar-of-Events-Header.jpg" ></a>
	    				</div>-->
		...
		<footer>
			<br></br>
			<p align="center">&copy; Eventify 2012 - <a href="http://twitter.com">Twitter</a> - <a href="https://www.facebook.com">Facebook</a></p>
			<br></br>
			<!--
